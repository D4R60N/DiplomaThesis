...
import palecek.nishita.NishitaPrecompute;
...
public class NishitaScene implements ILogic {
    ...
    private NishitaModel nishitaModel;
...
//         renderManager init
        ...
        NishitaPrecompute nishitaPrecompute = new NishitaPrecompute();
        nishitaPrecompute.precompute(new ComputeShaderManager(), 256, 64);
    }
