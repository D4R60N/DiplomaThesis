...
#define IRRADIANCE_TEXTURE_WIDTH uIrradianceTextureSize.y
...
layout(rgba32f, binding = 1) uniform image2D irradianceImage;
...
void main() {
    ...
    imageStore(irradianceImage, texelCoord, vec4(irradiance, 1));
}